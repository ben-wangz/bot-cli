...
Command:
go run ./cmd/proxmox-cli --api-base "${PVE_API_BASE_URL%/}/api2/json" --insecure-tls --output json action build_ubuntu_autoinstall_iso --source-iso build/ubuntu-24.04.2-live-server-amd64.iso --output-iso build/phase3-a52-autoinstall.iso --work-dir build/autoinstall-iso-work/phase3-a52
