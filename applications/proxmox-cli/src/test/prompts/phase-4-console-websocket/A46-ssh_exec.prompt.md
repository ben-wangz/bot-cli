...
Command:
go run ./cmd/proxmox-cli --api-base "${PVE_API_BASE_URL%/}/api2/json" --insecure-tls --output json action ssh_exec --host "$SHARED_GUEST_IP" --port 22 --user cloud --identity-file "$SHARED_IDENTITY_FILE" --timeout-seconds 20 --command "hostname"
